...
function diasporaChapter() {
  ...
  return `<div class="diaspora-water" aria-hidden="true"><i></i><i></i><i></i></div>${kicker("08 · CUBA Y BRASIL")}<div class="shore-labels"><span>CUBA<small>REGLA DE OCHA · LUCUMÍ</small></span><span>BRASIL<small>TRADICIONES AFROBRASILEÑAS</small></span></div>`
    ...
    + moment(4,null,"exu-scene",`<div class="exu-names"><strong>Elegguá<br><em>Eshú</em></strong><i aria-hidden="true">↔</i><strong>Exu</strong></div><p>Son relaciones históricas aproximadas.</p><p>En el Candomblé, Exu es un orixá. En la Umbanda, el nombre también designa entidades espirituales: no es el mismo uso.</p><b>No se asocia con el diablo.</b>`)
...
const chapters = [
  ...
  { number: 12, speaker: "Davi", maxState: 4, act: "V", actTitle: "EXPANSIÓN Y LEGADO", title: "¿Qué significa Síntesis?", theme: "finale", build: finaleChapter, source: "Síntesis · Carlos Alfonso / AM:PM · síntesis editorial" }
];
